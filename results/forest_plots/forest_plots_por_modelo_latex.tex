...
% y-axis row labels). Do NOT regenerate this file by running
% `generar_forest_latex.py` -- that script predates these corrections and
% would silently overwrite them with stale values.
% Compile: pdflatex forest_plots_por_modelo_latex.tex  (x2)
% ==================================================================
